#!/usr/bin/env python3
"""PROTOTYPE (wayfinder #87) — Fable's third-opinion reading, one call per item: third87.py add <short> <item> <R|C|N> <confidence> "<what>" "<deciding views>" "<resolved by>"; writes into items87.json."""
import json, sys
p = "items87.json"; items = json.load(open(p))
